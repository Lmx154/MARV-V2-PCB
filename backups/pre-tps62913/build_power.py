...
def build():
    src=Sheet('power_sources','POWER 1 / BEC, USB, 1S source isolation',2)
    ...
    src.add('J3','Connector_Generic:Conn_01x02','BEC 5 V 3 A in (2S-6S BEC)',35,95,{'1':'BEC_IN','2':'GND'},'Connector_JST:JST_XH_B2B-XH-A_1x02_P2.50mm_Vertical')
    for ref,y,net in [('U2',45,'CELL_IN'),('U3',95,'BEC_IN'),('U5',145,'USB_VBUS')]:
        src.add(ref,'MARV_Power:LM66100_OR','LM66100DCKR',240,y,{'1':net,'2':'GND','3':'VSYS','4':None,'5':ref+'_STATUS','6':'VSYS'})
    for rref,uref,y in [('R14','U2',45),('R15','U3',95),('R17','U5',145)]:
        src.passive(rref,'R','100k status pullup',175,y,'VSYS',uref+'_STATUS')
    ...
    out=Sheet('power_3v3','POWER 2 / 3.3 V avionics and USB interface',3)
    ...
    out.add('J5','Connector_Generic:Conn_01x06','MCU_INTERFACE_PENDING',365,200,{'1':'V3V3','2':'GND','3':'PWR_GOOD','4':'BB_MODE','5':'USB_DP_MCU','6':'USB_DM_MCU'},'Connector_PinHeader_2.54mm:PinHeader_1x06_P2.54mm_Vertical')
    out.add('U8','Power_Protection:USBLC6-2SC6','USBLC6-2SC6',245,220,{'1':'USB_DP','2':'GND','3':'USB_DM','4':'USB_DM_MCU','5':'USB_VBUS','6':'USB_DP_MCU'})
    out.note('PFM saves idle heat; drive BB_MODE high for FPWM after measuring noise/heat.\nUSB VBUS detection, supervisor, MCU and sensor decoupling remain integration work.',15,258,1.3)
    for n,net,y in [(15,'CELL_IN',45),(16,'BEC_IN',95)]:
    ...
    for sheet,net,x,y,num in [(src,'GND',400,20,1),(src,'CELL_IN',295,130,3),(src,'BEC_IN',355,130,4),(src,'USB_VBUS',295,180,5),(src,'VSYS',355,180,7)]:
