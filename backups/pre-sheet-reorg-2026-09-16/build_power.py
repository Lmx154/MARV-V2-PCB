...
def mcu_sheet():
    ...
    # array (POWER 3), rows 11-14 of the J6 signal column.  The other SIX (GPIO9, 12, 18, 21, 26, 27)
    ...
    s.passive('C48','C','100n / 16 V X7R, ADC1',*right[2],'VBAT_SENSE','GND')
    s.passive('R29','R','10k / 1%, VBUS top',*right[3],'USB_VBUS','VBUS_SENSE')
    s.passive('R30','R','15k / 1%, VBUS bottom',*right[4],'VBUS_SENSE','GND')
    s.passive('C49','C','100n / 16 V X7R, ADC0',*right[5],'VBUS_SENSE','GND')
