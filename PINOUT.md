...
External IO leaves the board on the 2 x 16 IO array J6 (left edge), the ESC pad row J3 (bottom edge), the
servo block J12-J14 (bottom edge) and the DBG pads J10 (top edge).
...
| 1 | IO_GPIO1 | GPIO | SPI0 CSn, UART0 RX, I2C0 SCL, PWM0 B, USB VBUS DET | spare on J6 |
...
| 21 | IO_GPIO21 | GPIO | SPI0 CSn, UART1 RX, I2C0 SCL, PWM2 B, CLOCK GPOUT0, USB OVCUR DET | spare on J6 |
...
| 27 | IO_GPIO27 | GPIO | SPI1 TX, UART1 RTS, I2C1 SCL, PWM5 B, USB OVCUR DET, UART1 RX (F11) | spare on J6 |
| 28 | IO_GPIO28 | GPIO | SPI1 RX, UART0 TX, I2C0 SDA, PWM6 A, USB VBUS DET | spare on J6 |
...
| 31 | IO_GPIO31 | GPIO | SPI1 TX, UART0 RTS, I2C1 SCL, PWM7 B, USB VBUS DET, UART0 RX (F11) | spare on J6 |
...
| 43 | IO_GPIO43 | GPIO / ADC3 | SPI1 TX, UART1 RTS, I2C1 SCL, PWM9 B, USB VBUS DET, UART1 RX (F11) | spare on J6 |
| 44 | IO_GPIO44 | GPIO / ADC4 | SPI1 RX, UART0 TX, I2C0 SDA, PWM10 A, USB VBUS EN | spare on J6 |
| 45 | IO_GPIO45 | GPIO / ADC5 | SPI1 CSn, UART0 RX, I2C0 SCL, PWM10 B, USB OVCUR DET | spare on J6 |
| 46 | IO_GPIO46 | GPIO / ADC6 | SPI1 SCK, UART0 CTS, I2C1 SDA, PWM11 A, USB VBUS DET, UART0 TX (F11) | spare on J6 |
| 47 | IO_GPIO47 | GPIO / ADC7 | SPI1 TX, UART0 RTS, I2C1 SCL, PWM11 B, QMI CS1n, USB VBUS EN, UART0 RX (F11) | spare on J6 |

## Table B — the ten spare GPIOs on J6 and what they can become
...
| GPIO | Advertised role | Also | Caveat |
| --- | --- | --- | --- |
| 44 | **I2C0 SDA** | ADC4, SPI1 RX, PWM10 A | pairs with 45 |
| 45 | **I2C0 SCL** | ADC5, SPI1 CSn, PWM10 B | pairs with 44 |
| 46 | **SPI1 SCK** | ADC6, PWM11 A | |
| 47 | **SPI1 TX (MOSI)** | ADC7, PWM11 B, QMI CS1n alt | |
| 43 | **ADC3** | SPI1 TX alt, PWM9 B | |
| 28 | SPI1 RX (MISO) / I2C0 SDA alt | PWM6 A (free slice) | |
| 1 | I2C0 SCL alt | SPI0 CSn (extra sensor CS), PWM0 B | |
| 21 | extra SPI0 CSn (a 4th sensor on the sensor bus) | I2C0 SCL alt, PWM2 B | PWM2 slice is the ESC M3/M4 slice |
| 27 | GPIO | SPI1 TX alt, PWM5 B | PWM5 slice is the servo S5/S6 slice — no independent PWM frequency |
| 31 | GPIO | SPI1 TX alt, PWM7 B | PWM7 slice is the servo S7/S8 slice — no independent PWM frequency |

Complete extra buses that do not conflict with anything on the board:
...
- **ADC3-7** on 43-47 whenever those pins are not used digitally.
...
| ADC | 0 VBAT_SENSE (40), 1 VBUS_SENSE (41), 2 CURR_SENSE (42); 3-7 on J6 spares | |
...
5. Every GPIO terminates on the board or on J6; none floats.
